...
namespace consoledotnet_bank
{
    class Program
    {
        ...
        private static int retornaNumeroConta()
        {
            int numeroConta;
            do
            {
            ...
            } while (numeroConta < 0 || numeroConta >= listContas.Count);
        ...
        private static void Transferir()
        {
            ...
            int indiceContaOrigem = retornaNumeroConta();

            Console.Write("Digite o número da conta de destino: ");
            int indiceContaDestino = retornaNumeroConta();
        ...
        private static void Sacar()
        {
            ...
            int indiceConta = retornaNumeroConta();
